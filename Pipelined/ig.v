...
module ig(
    ...
    always @(*) begin
        case(opcode)
            ...
            //jalr: I-type immediate (same encoding as addi - 12 bits, sign-extended to 64)
            7'b1100111: begin
                imm_data = { {52{instr[31]}}, instr[31:20] };
            end
            //s-type: store
            // sd (0100011)
            7'b0100011: begin
            ...
            //j-type: jal (1101111) - 21-bit signed offset, LSB always 0 (word-aligned)
            // imm[20|10:1|11|19:12] scattered across the instruction word
            7'b1101111: begin
                imm_data = { {44{instr[31]}}, instr[19:12], instr[20], instr[30:21], 1'b0 };
            end
